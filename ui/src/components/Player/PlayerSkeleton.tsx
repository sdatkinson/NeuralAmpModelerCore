...
export const PlayerSkeleton: React.FC<T3kPlayerProps> = ({ previewMode }) => {
  return (
      ...
      <div className='flex flex-col gap-2'>
        <div className='flex flex-row items-center gap-4 flex-wrap'>
          <div className='flex-1 min-w-[0px]'>
            <div className='flex w-full flex-1 min-w-[0px]'>
              <Select
                options={[]}
                label={previewMode === PREVIEW_MODE.MODEL ? 'Model' : 'IR'}
                onChange={() => {}}
                disabled
              />
            </div>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-2 sm:gap-6'>
          ...
          <div className='w-full sm:w-1/2'>
            <Select
              options={[]}
              label={previewMode === PREVIEW_MODE.MODEL ? 'IR' : 'Model'}
              onChange={() => {}}
              disabled
            />
          </div>
