...
nam::wavenet::_LayerArray::_LayerArray(const int input_size, const int condition_size, const int head_size,
                                       ...
                                       const int groups_input, const int groups_condition, const int groups_1x1)
...
, _head_scale(head_scale)
{
  ...
  for (size_t i = 0; i < layer_array_params.size(); i++)
  {
    this->_layer_arrays.push_back(nam::wavenet::_LayerArray(
      ...
      layer_array_params[i].groups_input, layer_array_params[i].groups_condition, layer_array_params[i].groups_1x1));
    if (i > 0)
                                                ...
                                                const double expectedSampleRate)
{
  ...
  for (size_t i = 0; i < config["layers"].size(); i++)
  {
    ...
    const int groups_condition = layer_config.value("groups_condition", 1); // defaults to 1
    ...
    layer_array_params.push_back(nam::wavenet::LayerArrayParams(
      ...
      layer_config["head_bias"], groups, groups_condition, groups_1x1));
  }
