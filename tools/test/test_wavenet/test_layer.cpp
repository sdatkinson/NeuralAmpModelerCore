...
void test_gated()
{
  ...
  auto layer = nam::wavenet::_Layer(conditionSize, channels, kernelSize, dilation, activation, gated, groups_input, groups_1x1);
...
void test_layer_activations()
{
  ...
  // Test Tanh activation
  {
    const int groups_input = 1;
    const int groups_1x1 = 1;
    auto layer = nam::wavenet::_Layer(conditionSize, channels, kernelSize, dilation, "Tanh", gated, groups_input, groups_1x1);
