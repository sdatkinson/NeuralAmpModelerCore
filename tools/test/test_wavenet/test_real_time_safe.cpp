...
void test_layer_process_realtime_safe()
{
  ...
  auto layer = nam::wavenet::_Layer(
    condition_size, channels, kernel_size, dilation, activation, gated, groups_input, groups_condition, groups_1x1);
...
void test_layer_array_process_realtime_safe()
{
  ...
  auto layer_array = nam::wavenet::_LayerArray(input_size, condition_size, head_size, channels, kernel_size, dilations,
                                               activation, gated, head_bias, groups, groups_condition, groups_1x1);
...
void test_process_realtime_safe()
{
  ...
  layer_array_params.push_back(nam::wavenet::LayerArrayParams(input_size, condition_size, head_size, channels,
                                                              ...
                                                              head_bias, groups, groups_condition, groups_1x1));
